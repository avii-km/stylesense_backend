"""
Django settings for stylesense_proj project.
...
ASGI_APPLICATION = 'stylesense_proj.asgi.application'
INSTALLED_APPS = [
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'stylesense_proj/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'stylesense_proj.wsgi.application'
...
CELERY_IMPORTS = [
    'stylesense_proj.celery_app.tasks'
]
# Celery application definition
CELERY_APP_NAME = 'stylesense-celery'
